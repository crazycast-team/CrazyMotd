package eu.crazycast.motd.bungee;

import eu.crazycast.motd.bungee.command.CrazyMotdCommand;
import eu.crazycast.motd.bungee.factory.BungeeCommandFactory;
import eu.crazycast.motd.bungee.factory.BungeeListenerFactory;
import eu.crazycast.motd.bungee.feature.BungeeMessageOfTheDayService;
import eu.crazycast.motd.bungee.listener.ProxyPingListener;
import eu.crazycast.motd.bungee.listener.ServerConnectListener;
import eu.crazycast.motd.bungee.placeholder.BungeePluginPlaceholders;
import eu.crazycast.motd.bungee.provider.BungeeLoggerProvider;
import eu.crazycast.motd.bungee.provider.BungeeServerProvider;
  ...
  private void setupMessageOfTheDayTask() {
    ...
    this.messageOfTheDayTask = Optionals.when(
        ...
        this.proxyServer.getScheduler().schedule(
            ...
            0L,
            this.configuration.updateTime.getSeconds(),
            TimeUnit.SECONDS
        )
    );
  }
