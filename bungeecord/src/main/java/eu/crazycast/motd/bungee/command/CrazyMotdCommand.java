package eu.crazycast.motd.bungee.command;
...
public class CrazyMotdCommand {
  ...
  public void reloadCommand(@Context CommandSender commandSender, @Arg Optional<String> args) {
    ...
    try {
      ...
      audience.sendMessage(ChatUtil.deserialize(this.configuration.configurationReloadSuccessMessage));
    } catch (OkaeriException exception) {
      exception.printStackTrace();
      audience.sendMessage(ChatUtil.deserialize(this.configuration.configurationReloadFailMessage));
    }
  }
}