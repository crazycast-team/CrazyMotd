...
public class PlayersConfiguration extends OkaeriConfig {
  ...
  public PlayersType playersType = PlayersType.REAL;
  ...
  public FakePlayersType fakePlayersType = FakePlayersType.STATIC;
  ...
  public Map<String, Integer> fakePlayersRange = new HashMap<String, Integer>() {{
    this.put("min", 50);
    this.put("max", 100);
  }};
