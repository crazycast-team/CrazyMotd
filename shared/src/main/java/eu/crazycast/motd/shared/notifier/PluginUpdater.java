...
public class PluginUpdater {
  ...
  public void notify(Audience audience) {
    ...
    Stream.of(
        ...
        "&8[&e#&8] &cDownload it from: &bhttps://github.com/crazycast-team/CrazyMotd/releases/latest"
  ...
  public void check() {
    ...
    try {
      ...
      if (latestVersion.equals(currentVersion)) {
        ...
        this.console.sendMessage(ChatUtil.deserialize(" &cDownload it from: &bhttps://github.com/crazycast-team/CrazyMotd/releases/latest"));
      }
  ...
  private String getLatestVersion() throws IOException {
    URL url = new URL("https://api.github.com/repos/crazycast-team/CrazyMotd/releases/latest");
