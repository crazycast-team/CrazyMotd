package eu.crazycast.motd.velocity.command;
...
import eu.crazycast.motd.velocity.VelocityMotd;
...
public class CrazyMotdCommand {
  ...
  public void defaultCommand(@Context CommandSource commandSource) {
    commandSource.sendMessage(Component.join(
        ...
        this.configuration.helpCommand.stream()
  ...
  public void reloadCommand(@Context CommandSource commandSource) {
    try {
      ...
      commandSource.sendMessage(ChatUtil.deserialize(this.configuration.configurationReloadSuccessMessage));
    } catch (OkaeriException exception) {
      exception.printStackTrace();
      commandSource.sendMessage(ChatUtil.deserialize(this.configuration.configurationReloadFailMessage));
    }
  }
}